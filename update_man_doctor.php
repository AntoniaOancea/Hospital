...
if(isset($_POST['update'])){
   ...
   if(empty($name) || empty($mail) || empty($password))
      ...
      $update_data = "UPDATE doctors SET name='$name', mail='$mail', password='$password'  WHERE id_doctor = '$id'";
      $upload = mysqli_query($conn, $update_data);
      header("location:man_doctor.php");
   }
};
...
<div class="container">
    ...
    <?php
        ...
        $select = mysqli_query($conn, "SELECT * FROM doctors WHERE id_doctor = '$id'");
